...
@Component({
  selector: 'app-deviations-work-transfer-request',
  templateUrl: './deviations-work-transfer-request.component.html',
  styleUrls: ['./deviations-work-transfer-request.component.scss'],
  providers: [ConfirmationService, MessageService]
})
export class DeviationsWorkTransferRequestComponent {
