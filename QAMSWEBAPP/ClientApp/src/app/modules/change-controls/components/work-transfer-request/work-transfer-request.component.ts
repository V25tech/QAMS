...
@Component({
  selector: 'app-work-transfer-request',
  templateUrl: './work-transfer-request.component.html',
  styleUrls: ['./work-transfer-request.component.scss'],
  providers: [ConfirmationService, MessageService],

})
export class WorkTransferRequestComponent {
