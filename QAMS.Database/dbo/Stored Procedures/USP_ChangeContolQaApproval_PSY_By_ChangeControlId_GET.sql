  CREATE PROCEDURE [dbo].[USP_ChangeContolQaApproval_PSY_By_ChangeControlId_GET] @ChangeControlId int 
 AS 
 BEGIN 
 BEGIN TRY 
...
ModifiedBy_PSY,
ModifiedDate_PSY 
  FROM [dbo].[ChangeContolQaApproval_PSY] WITH (NOLOCK) where ChangeControlId_PSY = @ChangeControlId   
 END TRY 
 BEGIN CATCH 
