...
@Component({
  selector: 'app-deviation-customer-notification',
  templateUrl: './deviation-customer-notification.component.html',
  styleUrls: ['./deviation-customer-notification.component.scss']
})
export class DeviationCustomerNotificationComponent {
