...
@Component({
  selector: 'app-deviations-workflow',
  templateUrl: './deviations-workflow.component.html',
  styleUrls: ['./deviations-workflow.component.scss']
})
export class DeviationsWorkflowComponent {
