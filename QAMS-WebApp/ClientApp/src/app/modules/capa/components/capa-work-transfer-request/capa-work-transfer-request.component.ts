...
@Component({
  selector: 'app-capa-work-transfer-request',
  templateUrl: './capa-work-transfer-request.component.html',
  styleUrls: ['./capa-work-transfer-request.component.scss'],
  providers: [ConfirmationService, MessageService]
})
export class CapaWorkTransferRequestComponent {
