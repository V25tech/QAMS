...
const routes: Routes = [
  ...
  {path:'edit-role-registration',component:NewRoleComponent, canActivate: [AuthGuard]},
  ...
  {path:'edit-user-group-registration',component:RegNewUserGroupComponent, canActivate: [AuthGuard]},
